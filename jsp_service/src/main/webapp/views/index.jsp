		...
		<body class="background_img">
            ...
            <form action="/search_property" method="post" style="display: flex; align-items: center; flex-wrap: wrap; background-color: white; padding: 10px; font-family: Helvetica, Arial, sans-serif; font-weight: 600; color: #484848; border-radius: 5px;">
                <div style="padding: 10px 20px; margin-left: 80px">
                    <label>WHERE</label>
                    <input type="text" placeholder="Anywhere" name="address" style="padding: 5px; border: 1px solid #ccc; border-radius: 4px;"/>
                </div>
			...
			<%
				...
				<div class="col-md-4">
					<div class="card" style="width: 18rem;">
						<img src="${pageContext.request.contextPath}<%=propertyDTOS.get(i).getPictureLocation()%>" class="card-img-top" alt="...">
						<div class="card-body">
							<h5 class="card-title"><%=propertyDTOS.get(i).getAddress()%></h5>
							<p class="card-text">Features:
								<%for(FeatureDTO feature : propertyDTOS.get(i).getFeatures()){%>
